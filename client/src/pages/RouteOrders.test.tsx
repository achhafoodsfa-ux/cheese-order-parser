...
describe("RouteOrders workspace", () => {
  it("shows one day-end Excel upload entry point and explains its compact route-matrix workflow", () => {
    render(<RouteOrders />);
    expect(screen.getByRole("heading", { name: /Route-wise customer matrix/i })).toBeTruthy();
